...
/* Platform-specific struct member compatibility */
#ifdef __FreeBSD__
/* FreeBSD uses th_* names for TCP headers */
#define TCP_CHECKSUM tcphdr->th_sum
#define UDP_CHECKSUM udphdr->uh_sum
#else
/* Linux and other systems use different names */
#define TCP_CHECKSUM tcphdr->check
#define UDP_CHECKSUM udphdr->check
#endif
...
#define uh_sport th_sport
#define uh_dport th_dport
#define uh_ulen th_ulen
#define uh_sum th_sum
#else
/* Linux and other systems */
